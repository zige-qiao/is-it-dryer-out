...
See [iOS voice recognition investigation](VOICE-INVESTIGATION.md) for the consolidated device-test record, event timings, microphone-reset result, current findings, and related WebKit reports. The supporting [video analysis](tests/ios_web_speech_microphone_video_analysis.md) documents the Safari and Chrome screen recording in detail.
